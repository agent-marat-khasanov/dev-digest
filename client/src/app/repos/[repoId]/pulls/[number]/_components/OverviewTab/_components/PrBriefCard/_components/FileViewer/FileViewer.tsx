...
/**
 * In-app file viewer for the brief's file-reference chips (AC-6/AC-7/AC-11).
 * Reuses `useRepoFile` like the tour's FileViewer / Blast tab's CodeViewer,
 * but has no line target — brief references are whole-file paths, not
 * line-level call sites. Modal: closes on Escape or backdrop click.
 */
